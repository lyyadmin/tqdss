...
/**
 * <p>getDriverPlanByHouseCodeAndTime complex type的 Java 类。
 * 
 * <p>以下模式片段指定包含在此类中的预期内容。
 * 
 * <pre>
 * &lt;complexType name="getDriverPlanByHouseCodeAndTime">
 *   &lt;complexContent>
...
@XmlType(name = "getDriverPlanByHouseCodeAndTime", propOrder = {
    "houseCode",
    "beginTime",
    "endTime"
})
public class GetDriverPlanByHouseCodeAndTime {
