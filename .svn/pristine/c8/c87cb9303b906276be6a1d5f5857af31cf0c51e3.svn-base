...
<div class="modal" id="addFileCauseModal" role="dialog">
        <div class="modal-dialog">
        	<div class="modal-content">
	            ...
	            <div class="panel-body" style="text-align:center">
	               	<form id="addFileCauseForm" class="form-horizontal">
       		   ...
       		   <div class="panel-footer" style="text-align:right">
                   <button type="button" style="margin-left:0px;width:100px;"
                                      class="btn btn-primary" onclick="addFileExceptionCauseRowData()" data-dismiss="modal">确定</button>
